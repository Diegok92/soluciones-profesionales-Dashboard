...
if (price.value == "") {
    ...
    else if (whyMe.value.match(reOnlyNumber != null)) {errors.push("El Precio solo puede contener numeros")}
...
if (cbu.value == "") {
    ...
    else if (cbu.value.match(reOnlyNumber) == null ) {errors.push("El CBU solo puede contener numeros")}
